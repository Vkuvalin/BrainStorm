...
**BrainStorm** — это Android-реализация культовой интеллектуальной PvP-игры на развитие способностей мозга вдохновлённая BrainWars. В ней два игрока соревнуются в когнитивных мини-играх: на логику, внимание, память, скорость реакции, точность и вычисление. **Проект** воспроизводит ключевые элементы UX и визуальный стиль: навигацию, PVP-контур, систему раундов и результатов, статистику, социальные функции, подсчёт очков, анимации и часть когнитивных мини-игр. BrainStorm — Android-реализация интеллектуальной PvP-игры. 
...
- 🧩 Две полноценно реализованные мини-игры: Flick Master и Path to Safety; остальные представлены расширяемым каркасом и визуальными ресурсами.
...
`BrainStorm — некоммерческий portfolio/learning-проект, вдохновлённый BrainWars; проект не связан с правообладателями оригинальной игры.`
